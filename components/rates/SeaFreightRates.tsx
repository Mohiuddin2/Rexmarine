            ...
            <CardHeader>
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-2xl font-black text-white">{container.price}</div>
                </div>
              </div>
              <CardTitle className="text-2xl font-black text-white">{container.type}</CardTitle>
            </CardHeader>
            <CardContent>
      ...
      <Card className="bg-[#0B192C] border-2 border-white/10">
        <CardContent className="pt-6">
          <p className="text-gray-300 mb-4">
            <span className="font-semibold text-white">Note:</span> Prices may vary.
          </p>
          <p className="text-gray-300">
            Sea freight charges are based on dimensions and weight, with a rate of{" "}
            <span className="font-bold text-[#3a67e2]">$20 per cubic foot</span>.
          </p>
        </CardContent>
      </Card>
    </div>
